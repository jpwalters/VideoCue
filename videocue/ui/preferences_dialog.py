...
class PreferencesDialog(QDialog):
    ...
    def __init__(self, config, parent=None, usb_controller=None):
        ...
        logger.debug("PreferencesDialog: UI initialized, setting stylesheet...")
        ...
        logger.debug("PreferencesDialog: Initialization complete, ready for display")
